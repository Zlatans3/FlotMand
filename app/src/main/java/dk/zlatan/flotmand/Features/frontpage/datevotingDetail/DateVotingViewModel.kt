...
internal class DateVotingViewModel
    @AssistedInject
    constructor(
        ...
        private val _uiState: MutableStateFlow<DateVotingUiState> =
            MutableStateFlow(
                DateVotingUiState(
        ...
        init {
            notificationService.markAsReadByReferenceId(votingId)
            viewModelScope.launch {
                try {
                    ...
                    if (voting != null) {
                        ...
                        _uiState.update {
                            it.copy(
                                errorMessage = stringProvider.getString(R.string.error_voting_not_found),
                                isLoading = false,
                            )
                        }
                    }
