                ...
                suspendCancellableCoroutine { continuation ->
                    ...
                    requestBuilder.setLocationBias(
                        RectangularBounds.newInstance(
                            com.google.android.gms.maps.model.LatLng(55.5, 12.3), // Southwest
                            com.google.android.gms.maps.model.LatLng(55.8, 12.8)  // Northeast
                        )
                    )
                    ...
                    placesClient.findAutocompletePredictions(requestBuilder.build())
                        ...
                        .addOnFailureListener { exception ->
                            Log.e(TAG, "Error fetching predictions: ${exception.message}", exception)
            ...
            try {
                suspendCancellableCoroutine { continuation ->
                    ...
                    placesClient.fetchPlace(request)
                        ...
                        .addOnFailureListener { exception ->
                            Log.e(TAG, "Error fetching place details: ${exception.message}", exception)
                            continuation.resume(null)
                        }
                }
            } catch (e: Exception) {
